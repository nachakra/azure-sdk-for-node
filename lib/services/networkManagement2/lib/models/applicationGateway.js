...
class ApplicationGateway extends models['Resource'] {
   ...
   * exclusion list.
   * @property {object} [firewallPolicy] Web application firewall policy.
   * @property {object} [firewallPolicy.policySettings] Describes
   * policySettings for policy
   * @property {string} [firewallPolicy.policySettings.enabledState] describes
   * if the policy is in enabled state or disabled state. Possible values
   * include: 'Disabled', 'Enabled'
   * @property {string} [firewallPolicy.policySettings.mode] Describes if it is
   * in detection mode  or prevention mode at policy level. Possible values
   * include: 'Prevention', 'Detection'
   * @property {object} [firewallPolicy.customRules] Describes custom rules
   * inside the policy
   * @property {array} [firewallPolicy.customRules.rules] List of rules
   * @property {array} [firewallPolicy.applicationGateways] A collection of
   * references to application gateways.
   * @property {string} [firewallPolicy.provisioningState] Provisioning state
   * of the WebApplicationFirewallPolicy.
   * @property {string} [firewallPolicy.resourceState] Possible values include:
   * 'Creating', 'Enabling', 'Enabled', 'Disabling', 'Disabled', 'Deleting'
   * @property {string} [firewallPolicy.etag] Gets a unique read-only string
