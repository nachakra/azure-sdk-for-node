...
class Formula extends models['BaseResource'] {
   ...
   * machine administrator.
   * @property {boolean} [formulaContent.isAuthenticationWithSshKey] A value
   ...
   * @property {string} [formulaContent.id] The identifier of the resource.
   * @property {string} [formulaContent.name] The name of the resource.
   * @property {string} [formulaContent.type] The type of the resource.
   * @property {string} [formulaContent.location] The location of the resource.
