...
class CustomImage extends models['BaseResource'] {
   ...
   * @property {boolean} [vm.sysPrep] Indicates whether sysprep has been run on
   * the VHD.
   ...
   * @property {string} [vm.linuxOsInfo.linuxOsState] The state of the Linux
   * OS. Possible values include: 'NonDeprovisioned', 'DeprovisionRequested',
   * 'DeprovisionApplied'
   ...
   * @property {string} [osType] The OS type of the custom image. Possible
