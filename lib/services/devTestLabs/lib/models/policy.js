...
class Policy extends models['BaseResource'] {
   ...
   * @property {string} [factName] The fact name of the policy. Possible values
   * include: 'UserOwnedLabVmCount', 'LabVmCount', 'LabVmSize', 'GalleryImage',
   * 'UserOwnedLabVmCountInSubnet'
   * @property {string} [factData] The fact data of the policy.
   * @property {string} [threshold] The threshold of the policy.
   * @property {string} [evaluatorType] The evaluator type of the policy.
