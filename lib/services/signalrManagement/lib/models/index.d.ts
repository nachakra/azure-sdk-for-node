...
export interface ResourceSku {
  ...
  name: string;
  /**
   * Optional tier of this particular SKU. `Basic` is deprecated, use `Standard` instead for Basic
...
export interface SignalRResource extends TrackedResource {
  ...
  /**
   * The publicly accessibly port of the SignalR service which is designed for browser/client side
   * usage.
   */
  readonly publicPort?: number;
  /**
   * The publicly accessibly port of the SignalR service which is designed for customer server side
   * usage.
   */
